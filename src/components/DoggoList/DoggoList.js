...
class DoggoList extends Component {
    render() {
        ...
        const noDogsReturned = doggos.length === 0 && this.props.shouldFetchMore === false;
            ...
            <div>
                ...
                <div>
                    <InfiniteScroll
                        ...
                        useWindow={true}
                    >
                    { noDogsReturned ? <div className='loader no-matches'>Sorry, no doggos matching your request</div> : console.log('all is good')}
